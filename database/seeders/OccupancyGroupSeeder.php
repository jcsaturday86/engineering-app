...
class OccupancyGroupSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('occupancy_sub_groups')->insert([
            ...
            ['id' => 4,  'occupancy_group_id' => 1,  'name' => 'Others',                                                                     'sort_order' => 4, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group B
            ...
            ['id' => 11, 'occupancy_group_id' => 2,  'name' => 'Others',                                                                     'sort_order' => 7, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group C
            ...
            ['id' => 17, 'occupancy_group_id' => 3,  'name' => 'Others',                                                                     'sort_order' => 6, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group D
            ...
            ['id' => 21, 'occupancy_group_id' => 4,  'name' => 'Others',                                                                     'sort_order' => 4, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group E
            ...
            ['id' => 27, 'occupancy_group_id' => 5,  'name' => 'Others',                                                                     'sort_order' => 6, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group F
            ...
            ['id' => 29, 'occupancy_group_id' => 6,  'name' => 'Others',                                                                     'sort_order' => 2, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group G
            ...
            ['id' => 32, 'occupancy_group_id' => 7,  'name' => 'Others',                                                                     'sort_order' => 3, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group H
            ...
            ['id' => 34, 'occupancy_group_id' => 8,  'name' => 'Others',                                                                     'sort_order' => 2, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group I
            ...
            ['id' => 36, 'occupancy_group_id' => 9,  'name' => 'Others',                                                                     'sort_order' => 2, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            // Group J
            ...
            ['id' => 38, 'occupancy_group_id' => 10, 'name' => 'J-1 Others',                                                                 'sort_order' => 2, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
            ...
            ['id' => 40, 'occupancy_group_id' => 10, 'name' => 'J-2 Others',                                                                 'sort_order' => 4, 'is_active' => 1, 'created_at' => $now, 'updated_at' => $now],
        ]);
    }
}
