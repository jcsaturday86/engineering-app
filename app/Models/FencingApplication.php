...
class FencingApplication extends Model implements PermitApplicationContract
{
    use HasPermitApplicationBehavior, LogsActivity, SoftDeletes;

    protected $table = 'fencing_applications';
    ...
    protected $fillable = [
        ...
        'design_professional_prc_no',
        'design_professional_prc_validity',
        'design_professional_ptr_no',
        'design_professional_ptr_date_issued',
        'design_professional_ptr_issued_at',
        'design_professional_tin',
    ...
    protected function casts(): array
    {
        return [
            ...
            'design_professional_prc_validity' => 'date',
            'design_professional_ptr_date_issued' => 'date',
     ...
     * building_barangay_id — a column that doesn't exist on this table. Fencing
     * applications use construction_barangay_id instead, but generic code (e.g.
    ...
    {
        return $this->belongsTo(Barangay::class, 'construction_barangay_id');
    }

    public function constructionBarangay(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
