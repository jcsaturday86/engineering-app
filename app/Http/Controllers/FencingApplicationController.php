...
class FencingApplicationController extends Controller
{
    ...
    private function validateApplication(Request $request): array
    {
        $validated = $request->validate([
            ...
            'applicant_telephone' => 'required|string|max:20',
            // Enterprise
            'owned_by_enterprise' => 'nullable|boolean',
            'enterprise_name' => 'required_if:owned_by_enterprise,1|nullable|string|max:255',
            'form_of_ownership_id' => 'required_if:owned_by_enterprise,1|nullable|exists:form_of_ownerships,id',
            // Address
            ...
            'applicant_street' => 'required|string|max:255',
            'applicant_zip_code' => 'required|string|max:10',
            'applicant_ctc_no' => 'required|string|max:50',
            'applicant_ctc_date_issued' => 'required|date',
            'applicant_ctc_issued_at' => 'required|string|max:255',
            ...
            'scope_of_work_detail' => 'required_if:scope_of_work,repair,others|nullable|string|max:500',
            // Design Professional, Plans and Specifications
            'design_professional_name' => 'required|string|max:255',
            'design_professional_address' => 'required|string|max:255',
            'design_professional_prc_no' => 'required|string|max:50',
            'design_professional_prc_validity' => 'required|date',
            'design_professional_ptr_no' => 'required|string|max:50',
            'design_professional_ptr_date_issued' => 'required|date',
            'design_professional_ptr_issued_at' => 'required|string|max:255',
            'design_professional_tin' => 'required|string|max:50',
            ...
            'owner_ctc_no' => 'required|string|max:50',
            'owner_ctc_date_issued' => 'required|date',
            'owner_ctc_issued_at' => 'required|string|max:255',
            // Misc
