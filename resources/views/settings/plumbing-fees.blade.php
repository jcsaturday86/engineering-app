...
@section('breadcrumbs')
    ...
    <i class="fas fa-chevron-right text-xs mx-2 text-gray-400"></i>
    <span class="text-gray-900 font-medium">Plumbing Fees</span>
@endsection

@section('content')
<div class="space-y-6">
    <div>
        <h2 class="text-xl font-bold text-gray-900">Plumbing Permit Fees</h2>
        <p class="text-sm text-gray-500 mt-1">
            Fee rates for plumbing permit assessment. Organized by fixture type and category.
        </p>
    </div>
    ...
    @php $clr = $sectionColors[$section['color']] ?? $sectionColors['blue']; @endphp
                    ...
                    <table class="w-full text-xs">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr x-data="{ editing: false }" class="hover:bg-gray-50">
                                    ...
                                    <td colspan="8" class="px-3 py-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center gap-2 ml-3 shrink-0">
                                                ...
                                                <form action="{{ route('settings.plumbing-fees.schedule.destroy', $schedule) }}" method="POST"
                                ...
                                <template x-if="editing">
                                    <td colspan="8" class="px-3 py-2">
                                        <form action="{{ route('settings.plumbing-fees.schedule.update', $schedule) }}"
                            ...
                            <tr>
                                <td colspan="8" class="px-3 py-2 bg-gray-50">
                                    ...
                                    <div x-show="adding" x-cloak>
                                        <form action="{{ route('settings.plumbing-fees.schedule.store', $feeType) }}"
