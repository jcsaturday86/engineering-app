...
@section('title', 'Electronics Fees')
...
@section('breadcrumbs')
    ...
    <i class="fas fa-chevron-right text-xs mx-2 text-gray-400"></i>
    <span class="text-gray-900 font-medium">Electronics Fees</span>
@endsection

@section('content')
<div class="space-y-6">
    <div>
        <h2 class="text-xl font-bold text-gray-900">Electronics Permit Fees</h2>
        <p class="text-sm text-gray-500 mt-1">
            Fee rates for electronics permit assessment. Organized by equipment category.
        </p>
    </div>
                    ...
                    <table class="w-full text-xs">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr x-data="{ editing: false }" class="hover:bg-gray-50">
                                    ...
                                    <td colspan="3" class="px-3 py-2">
                                        <div class="flex items-center justify-between">
                                            ...
                                            <div class="flex items-center gap-2 ml-3 shrink-0">
                                                ...
                                                <form action="{{ route('settings.electronics-fees.schedule.destroy', $schedule) }}" method="POST"
                                ...
                                <template x-if="editing">
                                    <td colspan="3" class="px-3 py-2">
                                        <form action="{{ route('settings.electronics-fees.schedule.update', $schedule) }}"
                            ...
                            <tr>
                                <td colspan="3" class="px-3 py-2 bg-gray-50">
                                    ...
                                    <div x-show="adding" x-cloak>
                                        <form action="{{ route('settings.electronics-fees.schedule.store', $feeType) }}"
