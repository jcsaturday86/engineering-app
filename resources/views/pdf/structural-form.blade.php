...
<div class="print-page p1">
    ...
    @endif
    <div class="hdr" style="top:0.62in;">Republic of the Philippines</div>
    <div class="hdr" style="top:0.86in; font-weight:bold;">{{ $settings['general.city'] ?? 'City of San Fernando' }}</div>
    <div class="hdr" style="top:1.10in;">Province of {{ $settings['general.province'] ?? 'La Union' }}</div>
