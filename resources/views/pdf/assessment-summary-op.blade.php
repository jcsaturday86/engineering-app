...
@php
    ...
    $barcodeVal = $referenceNo ?? (($application->permitType?->code ?? 'OP') . '-' . $application->app_year . '-' . str_pad($application->app_month,2,'0',STR_PAD_LEFT) . '-' . str_pad($application->app_counter,5,'0',STR_PAD_LEFT));
@endphp
