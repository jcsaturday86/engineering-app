...
<div class="space-y-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 class="text-xl font-bold text-gray-900">Billing</h2>
    </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="text-right px-4 py-3 font-medium text-gray-500">Assessment Total</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-right font-medium text-gray-900">
                            &#8369;{{ number_format($app->assessments->sum('total_amount'), 2) }}
                        </td>
                        <td class="px-4 py-3">
                            @php
                                $colors = [
                        ...
                        <td class="px-4 py-3 text-right">
                            ...
                            @else
                                <span class="inline-flex items-center gap-1 text-xs font-medium text-gray-600">
                                    ...
                                    {{ $app->billings->first()->billing_number }}
                                </span>
                            @endif
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="7" class="px-4 py-12 text-center text-gray-400">
                            ...
                            <p>No applications ready for billing</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
