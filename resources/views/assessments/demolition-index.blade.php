...
@section('title', 'Demolition Permit Assessment')
...
@section('breadcrumbs')
    ...
    <i class="fas fa-chevron-right text-xs mx-2 text-gray-400"></i>
    <span class="text-gray-900 font-medium">Demolition Permit</span>
@endsection
...
<div class="space-y-4">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 class="text-xl font-bold text-gray-900">Demolition Permit Assessment</h2>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <a href="{{ route('assessments.assess.dp', $app) }}" class="font-mono text-blue-600 hover:text-blue-800 font-medium">
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="inline-flex items-center gap-2">
                                ...
                                <a href="{{ route('assessments.print.dp', $app) }}" target="_blank"
                                ...
                                @endif
                                <a href="{{ route('assessments.assess.dp', $app) }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-600 text-white text-xs font-medium rounded-lg hover:bg-blue-700 transition">
