...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        <form method="GET" class="flex flex-wrap items-end gap-4">
            ...
            @if($statusFilter)
            <a href="{{ route('online.dashboard') }}" class="px-4 py-2 text-sm text-gray-500 hover:text-gray-700">Clear</a>
            @endif
        </form>
    </div>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr>
                        <td colspan="7" class="px-4 py-12 text-center text-gray-400">
                            ...
                            @if($statusFilter)
                            <p>No applications with this status. <a href="{{ route('online.dashboard') }}" class="text-blue-600">Clear filter</a></p>
                            @else
