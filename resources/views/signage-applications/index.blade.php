...
@section('title', 'Signage Permit Applications')

@section('breadcrumbs')
    <a href="{{ route('dashboard') }}" class="text-gray-500 hover:text-gray-700">Dashboard</a>
    <i class="fas fa-chevron-right text-xs mx-2 text-gray-400"></i>
    <span class="text-gray-900 font-medium">Signage Permit Applications</span>
@endsection

@section('content')
<div class="space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 class="text-xl font-bold text-gray-900">Signage Permit Applications</h2>
        @can('create-applications')
        <a href="{{ route('signage-applications.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition">
            <i class="fas fa-plus"></i> New Signage Permit
        </a>
        @endcan
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <a href="{{ route('signage-applications.show', $app) }}" class="font-mono text-indigo-600 hover:text-indigo-800 font-medium">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('signage-applications.show', $app) }}" class="text-gray-400 hover:text-indigo-600" title="View">
                    ...
                    <tr>
                        <td colspan="5" class="px-4 py-12 text-center text-gray-400">
                            ...
                            <p>No signage permit applications found</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
