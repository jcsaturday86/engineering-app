...
@section('title', 'Demolition Permit Applications')

@section('breadcrumbs')
    <a href="{{ route('dashboard') }}" class="text-gray-500 hover:text-gray-700">Dashboard</a>
    <i class="fas fa-chevron-right text-xs mx-2 text-gray-400"></i>
    <span class="text-gray-900 font-medium">Demolition Permit Applications</span>
@endsection

@section('content')
<div class="space-y-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h2 class="text-xl font-bold text-gray-900">Demolition Permit Applications</h2>
        @can('create-applications')
        <a href="{{ route('demolition-applications.create') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition">
            <i class="fas fa-plus"></i> New Demolition Permit
        </a>
        @endcan
    </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        <form method="GET" class="flex flex-wrap items-end gap-4" autocomplete="off">
            ...
            <div>
                ...
                <select name="source" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500">
                    <option value="">All</option>
            ...
            @if(request()->hasAny(['search', 'status', 'source']) || $dateFrom != now()->startOfYear()->toDateString() || $dateTo != now()->toDateString())
                <a href="{{ route('demolition-applications.index') }}" class="px-4 py-2 text-sm text-gray-500 hover:text-gray-700">Clear</a>
            @endif
            <a href="{{ route('demolition-applications.report', request()->query()) }}" target="_blank" title="Generate PDF Report"
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <a href="{{ route('demolition-applications.show', $app) }}" class="font-mono text-red-600 hover:text-red-800 font-medium">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('demolition-applications.show', $app) }}" class="text-gray-400 hover:text-red-600" title="View">
                    ...
                    <tr>
                        <td colspan="6" class="px-4 py-12 text-center text-gray-400">
                            ...
                            <p>No demolition permit applications found</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
