        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2" x-data="{ showRevertSubmitModal: false, revertSubmitPassword: '', showSubmitModal: false, submitPassword: '', showDisapprove: false, disapproveRemarks: '' }">
                ...
                @if($application->status === 'pending_approval')
                    ...
                    <form method="POST" action="{{ route('application-review.approve', ['type' => 'FP', 'id' => $application->id]) }}" class="inline" onsubmit="return confirm('Approve {{ $application->application_number }}? It will be routed into the normal assessment queue.');">
                        @csrf
