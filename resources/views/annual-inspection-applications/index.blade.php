    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        <form method="GET" class="flex flex-wrap items-end gap-4" autocomplete="off">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Owner/Lessee, application number..."
            ...
            <div>
                ...
                <select name="source" class="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-teal-500">
                    <option value="">All</option>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="text-left px-4 py-3 font-medium text-gray-500">Owner/Lessee</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-gray-900">{{ $app->owner_name }}</td>
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium {{ $app->application_kind === 'yearly' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700' }}">
                                {{ $app->application_kind === 'yearly' ? 'Yearly' : 'New' }}
                            </span>
                        </td>
                        <td class="px-4 py-3">
                            @php
