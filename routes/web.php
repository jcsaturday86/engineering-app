...
use App\Http\Controllers\AnnualInspectionApplicationController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('applications')->name('applications.')->group(function () {
        ...
        Route::get('/report', [ApplicationController::class, 'report'])->name('report')->middleware('can:view-applications');
    ...
    Route::prefix('occupancy-applications')->name('occupancy-applications.')->group(function () {
        ...
        Route::get('/report', [OccupancyApplicationController::class, 'report'])->name('report')->middleware('can:view-applications');
    ...
    Route::prefix('demolition-applications')->name('demolition-applications.')->group(function () {
        ...
        Route::get('/report', [DemolitionApplicationController::class, 'report'])->name('report')->middleware('can:view-applications');
    ...
    Route::prefix('signage-applications')->name('signage-applications.')->group(function () {
        ...
        Route::get('/report', [SignageApplicationController::class, 'report'])->name('report')->middleware('can:view-applications');
    ...
    Route::prefix('fencing-applications')->name('fencing-applications.')->group(function () {
        Route::get('/', [FencingApplicationController::class, 'index'])->name('index')->middleware('can:view-applications');
        Route::get('/report', [FencingApplicationController::class, 'report'])->name('report')->middleware('can:view-applications');
        Route::get('/create', [FencingApplicationController::class, 'create'])->name('create')->middleware('can:create-applications');
        Route::post('/', [FencingApplicationController::class, 'store'])->name('store')->middleware('can:create-applications');
        Route::get('/{fencingApplication}', [FencingApplicationController::class, 'show'])->name('show')->middleware('can:view-applications');
        Route::get('/{fencingApplication}/edit', [FencingApplicationController::class, 'edit'])->name('edit')->middleware('can:edit-applications');
        Route::put('/{fencingApplication}', [FencingApplicationController::class, 'update'])->name('update')->middleware('can:edit-applications');
    ...
    // Annual Inspection Applications (AI)
    Route::prefix('annual-inspection-applications')->name('annual-inspection-applications.')->group(function () {
        Route::get('/', [AnnualInspectionApplicationController::class, 'index'])->name('index')->middleware('can:view-applications');
        Route::get('/create', [AnnualInspectionApplicationController::class, 'create'])->name('create')->middleware('can:create-applications');
        Route::post('/', [AnnualInspectionApplicationController::class, 'store'])->name('store')->middleware('can:create-applications');
        Route::get('/{annualInspectionApplication}', [AnnualInspectionApplicationController::class, 'show'])->name('show')->middleware('can:view-applications');
        Route::get('/{annualInspectionApplication}/edit', [AnnualInspectionApplicationController::class, 'edit'])->name('edit')->middleware('can:edit-applications');
        Route::put('/{annualInspectionApplication}', [AnnualInspectionApplicationController::class, 'update'])->name('update')->middleware('can:edit-applications');
    ...
    Route::prefix('zoning')->name('zoning.')->middleware('can:view-zoning')->group(function () {
        ...
        Route::get('/report', [ZoningController::class, 'report'])->name('report');
    ...
    Route::prefix('assessments')->name('assessments.')->middleware('can:view-assessments')->group(function () {
        ...
        Route::get('/annual-inspection', [AssessmentController::class, 'annualInspectionIndex'])->name('annualInspection');
        // BP assessment
        ...
        // FP
        Route::get('/fp/{fencingApplication}', [AssessmentController::class, 'assessFp'])->name('assess.fp')->middleware('can:create-assessments');
        Route::post('/fp/{fencingApplication}/item', [AssessmentController::class, 'addItemFp'])->name('addItem.fp')->middleware('can:create-assessments');
        Route::post('/fp/{fencingApplication}/fence-item', [AssessmentController::class, 'addFenceItem'])->name('addFenceItem.fp')->middleware('can:create-assessments');
        Route::get('/fp/{fencingApplication}/summary', [AssessmentController::class, 'summaryFp'])->name('summary.fp');
        Route::post('/fp/{fencingApplication}/finalize', [AssessmentController::class, 'finalizeFp'])->name('finalize.fp')->middleware('can:finalize-assessments');
        ...
        Route::get('/ai/{annualInspectionApplication}', [AssessmentController::class, 'assessAi'])->name('assess.ai')->middleware('can:create-assessments');
        Route::post('/ai/{annualInspectionApplication}/insp-item', [AssessmentController::class, 'addAnnualInspectionFeeItem'])->name('addInspItem.ai')->middleware('can:create-assessments');
        Route::post('/ai/{annualInspectionApplication}/elec-item', [AssessmentController::class, 'addAnnualInspectionElectricalItem'])->name('addElecItem.ai')->middleware('can:create-assessments');
        Route::get('/ai/{annualInspectionApplication}/summary', [AssessmentController::class, 'summaryAi'])->name('summary.ai');
        Route::post('/ai/{annualInspectionApplication}/finalize', [AssessmentController::class, 'finalizeAi'])->name('finalize.ai')->middleware('can:finalize-assessments');
        Route::post('/ai/{annualInspectionApplication}/revert-finalize', [AssessmentController::class, 'revertEngineeringAi'])->name('revertFinalize.ai')->middleware('can:revert-assessments');
        Route::post('/ai/{annualInspectionApplication}/revert-to-draft', [AssessmentController::class, 'revertToDraftAi'])->name('revertToDraft.ai')->middleware('can:revert-submission');
        Route::get('/ai/{annualInspectionApplication}/print', [AssessmentController::class, 'printAi'])->name('print.ai');
        // Shared
    ...
    Route::prefix('collections')->name('collections.')->middleware('can:view-collections')->group(function () {
        ...
        Route::get('/ai/{annualInspectionApplication}/pay', [CollectionController::class, 'createAi'])->name('create.ai')->middleware('can:create-collections');
        Route::post('/ai/{annualInspectionApplication}/pay', [CollectionController::class, 'storeAi'])->name('store.ai')->middleware('can:create-collections');
        // Shared
    ...
    Route::prefix('permits')->name('permits.')->middleware('can:view-permits')->group(function () {
        ...
        Route::get('/annual-inspection', [PermitController::class, 'annualInspectionIndex'])->name('annualInspection');
        // BP permit
        ...
        Route::post('/ai/{annualInspectionApplication}/generate', [PermitController::class, 'generateAi'])->name('generate.ai')->middleware('can:generate-permits');
        Route::post('/ai/{annualInspectionApplication}/revert-generate', [PermitController::class, 'revertGenerateAi'])->name('revertGenerate.ai')->middleware('can:revert-permits');
