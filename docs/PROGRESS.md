...
| Discipline print routes | DONE | `applications/{id}/print-discipline/{discipline}` — Architectural and Structural render real NBC-form PDFs; the other 4 disciplines render a shared blank placeholder (`pdf/discipline-form.blade.php`) pending official source forms |
