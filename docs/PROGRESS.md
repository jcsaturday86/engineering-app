...
| Discipline print routes | DONE | `applications/{id}/print-discipline/{discipline}` — Architectural, Structural, Electrical, Sanitary, and Mechanical render real permit-form PDFs; Electronics renders a shared blank placeholder (`pdf/discipline-form.blade.php`) pending an official source form |
