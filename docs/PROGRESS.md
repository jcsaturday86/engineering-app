...
| Discipline print routes | DONE | `applications/{id}/print-discipline/{discipline}` — Architectural, Structural, and Electrical render real permit-form PDFs; the other 3 disciplines render a shared blank placeholder (`pdf/discipline-form.blade.php`) pending official source forms |
