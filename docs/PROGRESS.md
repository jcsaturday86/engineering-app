...
| Discipline print routes | DONE | `applications/{id}/print-discipline/{discipline}` — Architectural, Structural, Electrical, and Sanitary render real permit-form PDFs; the other 2 disciplines render a shared blank placeholder (`pdf/discipline-form.blade.php`) pending official source forms |
