...
**`discipline-form.blade.php` (DomPDF)** — shared blank placeholder for Mechanical/Electronics (no official source form digitized yet for these); A4 portrait, city seal header, form title from `ApplicationController::DISCIPLINE_FORMS`.
