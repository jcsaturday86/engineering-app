...
**`discipline-form.blade.php` (DomPDF)** — shared blank placeholder for Electronics (no official source form digitized yet); A4 portrait, city seal header, form title from `ApplicationController::DISCIPLINE_FORMS`.
